...
import { Search, MapPin, Bed, Bath, Square, Heart, ArrowRight, Shield, Compass, Bell, CheckCircle, Home as HomeIcon, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section className="featured-section">
        <div className="featured-header">
          ...
          <Link to="/search" className="featured-link">
      ...
      <section className="cta-section">
        <div className="cta-card">
          ...
          <div className="cta-buttons">
            ...
            <Link to="/search" className="cta-btn-secondary">Browse Listings</Link>
          </div>
        </div>
      </section>
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              <ul className="footer-links">
                ...
                <li className="footer-link"><a href="/search">New Listings</a></li>
                <li className="footer-link"><a href="/search">Price Trends</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="footer-links">
                ...
                <li className="footer-link"><a href="/search">Market Analysis</a></li>
                <li className="footer-link"><a href="/search">Pricing Guide</a></li>
              </ul>
            </div>
            <div>
